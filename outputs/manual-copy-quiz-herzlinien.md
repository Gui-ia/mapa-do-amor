# Manual de copy — Herzlinien-Porträt · versão 1
...
### Q1. Was führt dich heute zu deiner Herzlinie?

**PT:** O que te trouxe hoje à sua linha do coração?

- `connection` — **Ich möchte eine bestimmte Verbindung besser verstehen.** / Quero entender melhor uma conexão específica.
- `closure` — **Ich möchte mit einer vergangenen Liebe Frieden schließen.** / Quero fazer as pazes com um amor do passado.
- `new` — **Ich möchte mich für eine neue Liebe öffnen.** / Quero me abrir para um novo amor.

**Função:** Escolhe a intenção; não presume sofrimento. R01–R05, YouTube 7 e 11.

### Q2. Wie fühlt sich deine Situation gerade an?

**PT:** Como você sente sua situação neste momento?


**Ramo `connection`:**

- `mixed` — **Mal spüre ich Nähe, dann wieder Abstand.** / Às vezes sinto proximidade, depois distância.
- `silence` — **Wir haben gerade keinen Kontakt.** / Estamos sem contato.
- `together` — **Wir sind zusammen, aber etwas bleibt für mich offen.** / Estamos juntos, mas algo permanece em aberto para mim.
- `good` — **Es fühlt sich gut an. Ich bin einfach neugierig.** / Está tudo bem. Estou apenas curiosa.

**Ramo `closure`:**

- `thoughts` — **Ich denke noch oft an diese Person.** / Ainda penso muito nessa pessoa.
- `questions` — **Für mich sind Fragen offen geblieben.** / Algumas perguntas ficaram sem resposta.
- `ready` — **Ich bin bereit für einen neuen Anfang.** / Estou pronta para um recomeço.
- `meaning` — **Ich möchte verstehen, was diese Geschichte für mich bedeutet.** / Quero entender o que essa história significa para mim.

**Ramo `new`:**

- `trust` — **Ich wünsche mir Nähe, aber Vertrauen fällt mir schwer.** / Quero proximidade, mas tenho dificuldade de confiar.
- `repeat` — **Ich möchte alte Beziehungsmuster hinter mir lassen.** / Quero deixar antigos padrões de relacionamento para trás.
- `open` — **Ich bin offen und neugierig auf das, was kommt.** / Estou aberta e curiosa pelo que vem.
- `space` — **Ich möchte der Liebe wieder mehr Raum geben.** / Quero dar mais espaço ao amor.

**Função:** Contextualiza o capítulo principal. As alternativas mudam com Q1.

### Q3. Welcher Gedanke beschäftigt dich am meisten?

**PT:** Qual pensamento mais ocupa sua cabeça?

- `intuition` — **Ist das mein Bauchgefühl — oder meine Unsicherheit?** / É minha intuição ou minha insegurança?
- `chosen` — **Ich möchte spüren, dass ich wirklich gewählt werde.** / Quero sentir que sou realmente escolhida.
- `again` — **Werde ich mich noch einmal so verbunden fühlen?** / Será que vou sentir uma conexão assim novamente?
- `enough` — **Ich möchte mich so, wie ich bin, angenommen fühlen.** / Quero me sentir aceita como sou.
- `curious` — **Keiner davon. Ich möchte mich einfach besser kennenlernen.** / Nenhum desses. Só quero me conhecer melhor.

**Função:** Escolhe a tensão sem atribuir diagnóstico. F10, R03, R11, YouTube 6.

### Q4. Was wünschst du dir für dein nächstes Kapitel in der Liebe?

**PT:** O que você deseja para seu próximo capítulo no amor?

- `home` — **Eine Liebe, die sich wie Zuhause anfühlt.** / Um amor que pareça um lar.
- `mutual` — **Nähe, die von beiden Seiten kommt.** / Proximidade que venha dos dois lados.
- `peace` — **Mehr Ruhe in meinem Herzen.** / Mais paz no meu coração.
- `confidence` — **Mehr Vertrauen in mich und meine Entscheidungen.** / Mais confiança em mim e nas minhas decisões.
- `light` — **Leichtigkeit und neue Möglichkeiten.** / Leveza e novas possibilidades.

**Função:** Faz a transição da dor para o desejo. R02, R05, R12.

### Q5. Wie begegnest du spirituellen Deutungen?

**PT:** Como você se relaciona com interpretações espirituais?

- `mystic` — **Ich mag ihre Symbolik und spirituelle Tiefe.** / Gosto do simbolismo e da profundidade espiritual.
- `open` — **Ich bin offen, auch wenn ich nicht alles glaube.** / Estou aberta, mesmo sem acreditar em tudo.
- `simple` — **Ich bin neugierig und mag klare, einfache Erklärungen.** / Sou curiosa e gosto de explicações claras e simples.

**Função:** Ajusta o tom, nunca a suposta precisão. R06, R08. É a primeira pergunta a retirar se causar abandono.

### Q6. Wie dürfen wir dich nennen?

**PT:** Como podemos te chamar?

Campo: **Dein Vorname (optional)**. Botão secundário: **Ohne Namen weiter** / Continuar sem nome.

**Função:** Primeiro nome opcional; não aumenta a interpretação da mão.

### Q7. Welche Hand möchtest du fotografieren?

**PT:** Qual mão você quer fotografar?

- `right` — **Meine rechte Hand.** / Minha mão direita.
- `left` — **Meine linke Hand.** / Minha mão esquerda.

**Função:** Elimina confusão entre as mãos e garante legenda correta. F05–F07, YouTube 17–18.
...
**Título DE:** Nähe, die sich für dich stimmig anfühlt

**PT:** Uma proximidade que faça sentido para você

**Prévia DE:** Du möchtest eine bestimmte Verbindung besser verstehen. Dein Porträt greift deshalb auf, was dir in dieser Verbindung wichtig ist und welche Form von Nähe du dir wünschst.

**Capítulo prometido:** Deine Verbindung: Nähe, Erwartungen und Gegenseitigkeit

**Pergunta de reflexão:** Woran würdest du im Alltag erkennen, dass Nähe von beiden Seiten kommt?

### Ramo closure

**Título DE:** Ein neues Kapitel, in dem deine Geschichte Platz hat

**PT:** Um novo capítulo em que sua história tem lugar

**Prévia DE:** Du möchtest mit einer vergangenen Liebe Frieden schließen. Dein Porträt gibt dieser Geschichte Raum und richtet den Blick auf das, was du für dich mitnehmen oder hinter dir lassen möchtest.

**Capítulo prometido:** Dein Übergang: Erinnerungen, Abschied und neuer Raum

**Pergunta de reflexão:** Was möchtest du aus dieser Geschichte bewahren — und was nicht weitertragen?

### Ramo new

**Título DE:** Raum für eine Liebe, in der du du selbst sein kannst

**PT:** Espaço para um amor em que você possa ser você mesma

**Prévia DE:** Du möchtest dich für eine neue Liebe öffnen. Dein Porträt stellt deshalb deine Wünsche an Nähe, Vertrauen und einen neuen Anfang in den Mittelpunkt.

**Capítulo prometido:** Dein Neubeginn: Vertrauen, Wünsche und Möglichkeiten

**Pergunta de reflexão:** Welche kleine Erfahrung würde dir zeigen, dass du dich bei jemandem wohl und frei fühlst?

### Exemplo composto — cliente fictícia Lena
